...
a reference to you can extract ideas and adapte it to your solution.
*/
...
void bitClean(){
  //...........DDDDAAAAAA
  //...........0123012345
    send_cmd(0B0000000000101);// 0:3
    send_cmd(0B0000100000101);// 4:7
    send_cmd(0B0000010000101);// 8:11
    send_cmd(0B0000110000101);//12:15
    send_cmd(0B0000001000101);//16:19
    send_cmd(0B0000101000101);//20:23
    send_cmd(0B0000011000101);//24:27
    send_cmd(0B0000111000101);//28:31
    //
    send_cmd(0B0000000100101);//32:35
    send_cmd(0B0000100100101);//36:39
    send_cmd(0B0000010100101);//40:43
    send_cmd(0B0000110100101);//44:47
    send_cmd(0B0000001100101);//48:51
    send_cmd(0B0000101100101);//52:55
    send_cmd(0B0000011100101);//56:59
    send_cmd(0B0000111100101);//60:63
    //a0-a15 ... d0-d15
    send_cmd(0B0000000010101);//64:67
    send_cmd(0B0000100010101);//68:71
    send_cmd(0B0000010010101);//72:75
    send_cmd(0B0000110010101);//76:79
    send_cmd(0B0000001010101);//80:83
    send_cmd(0B0000101010101);//84:87
    send_cmd(0B0000011010101);//88:91
    send_cmd(0B0000111010101);//92:95
    //
    send_cmd(0B0000000110101);// 96:99
    send_cmd(0B0000100110101);//100:103
    send_cmd(0B0000010110101);//104:107
    send_cmd(0B0000110110101);//108:111
    send_cmd(0B0000001110101);//112:115
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
//
void anime0(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000101000101);//20:23
    send_cmd(0B0000011000101);//24:27
    send_cmd(0B0001111000101);//28:31
    //
    send_cmd(0B0000000100101);//32:35
    send_cmd(0B0000100100101);//36:39
    send_cmd(0B0000010100101);//40:43
...
void anime1(){
  ...
  //...........0123012345
    ...
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B1000111110101);//124:127
}
void anime2(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B0100111110101);//124:127
}
void anime3(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B0010111110101);//124:127
}
void anime4(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B0001111110101);//124:127
}
void anime5(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B1111111110101);//124:127
}
//
void anime00(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000001110101);//112:115
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B1000011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
void anime11(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000001110101);//112:115
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0100011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
void anime22(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000001110101);//112:115
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B0010011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
void anime33(){
  //...........DDDDAAAAAA
  //...........0123012345
    ...
    send_cmd(0B0000001110101);//112:115
    send_cmd(0B0000101110101);//116:119
    send_cmd(0B1110011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
//
void msgHiFolks(){
  ...
  //...........3210012345
    send_cmd(0B0000000000101);// 0:3
    send_cmd(0B1010100000101);// 4:7
    send_cmd(0B0001010000101);// 8:11
    send_cmd(0B1101110000101);//12:15
    send_cmd(0B0100001000101);//16:19
    send_cmd(0B0000101000101);//20:23
    send_cmd(0B0000011000101);//24:27
    send_cmd(0B0000111000101);//28:31
    //
    send_cmd(0B0101000100101);//32:35
    send_cmd(0B0000100100101);//36:39
    send_cmd(0B0000010100101);//40:43
    send_cmd(0B1000110100101);//44:47
    send_cmd(0B0101001100101);//48:51
    send_cmd(0B0101101100101);//52:55
    send_cmd(0B1001011100101);//56:59
    send_cmd(0B0101111100101);//60:63
    //a0-a15 ... d0-d15
    send_cmd(0B0000000010101);//64:67
    send_cmd(0B0000100010101);//68:71
    send_cmd(0B0000010010101);//72:75
    send_cmd(0B0101110010101);//76:79
    send_cmd(0B0101001010101);//80:83
    send_cmd(0B0000101010101);//84:87
    send_cmd(0B0000011010101);//88:91
    send_cmd(0B0000111010101);//92:95
    //
    send_cmd(0B0000000110101);// 96:99
    send_cmd(0B1011100110101);//100:103
    send_cmd(0B0000010110101);//104:107
    send_cmd(0B0101110110101);//108:111
    send_cmd(0B0100001110101);//112:115
    send_cmd(0B0101101110101);//116:119
    send_cmd(0B0000011110101);//120:123
    send_cmd(0B0000111110101);//124:127
}
...
//The next lines below belongs to the function to flip the byte and return it inverted as byte!!!
